...
public static class L10n
{
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["route_auto"] = "Automatic · fastest available",
        ["route_add"] = "Add address",
        ["route_active"] = "Active",
        ["route_pin"] = "Prefer this address",
        ["route_hint"] = "One server, multiple addresses. Verified routes fail over automatically; usage is counted once.",
        ["route_mismatch"] = "This address belongs to another server, or cannot prove its identity.",
        ["route_address"] = "Address (HTTPS or HTTP)",
        ["route_offline"] = "Unavailable",
        ["route_check"] = "Check addresses",
        ["route_remove"] = "Remove address",
        ["route_remove_last"] = "Remove this server and its last address?",
        ["route_add_hint"] = "Paste an address. Without a protocol, HTTPS is tried first, then HTTP.",
        ["server_label"] = "Label",
    ...
    private static readonly Dictionary<string, string> Zh = new()
    {
        ...
        ["section_server"] = "服务器",
        ["section_servers"] = "服务器",
        ["route_auto"] = "自动 · 最快可用地址",
        ["route_add"] = "添加地址",
        ["route_active"] = "使用中",
        ["route_pin"] = "优先使用此地址",
        ["route_hint"] = "一台服务器可有多个地址。已验证的地址会自动故障转移，用量仅统计一次。",
        ["route_mismatch"] = "此地址属于其他服务器，或无法验证其身份。",
        ["route_address"] = "地址（HTTPS 或 HTTP）",
        ["route_offline"] = "不可用",
        ["route_check"] = "检查地址",
        ["route_remove"] = "移除地址",
        ["route_remove_last"] = "移除此服务器及其最后一个地址？",
        ["route_add_hint"] = "粘贴地址。未输入协议时先尝试 HTTPS，再尝试 HTTP。",
        ["server_label"] = "名称",
        ["add_server"] = "添加服务器",
