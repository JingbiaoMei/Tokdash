...
- **Hermes**: `~/.hermes/state.db` (override via `HERMES_HOME` env var, comma-separated list of dirs); Session Explorer reads conversations and messages from the same databases
