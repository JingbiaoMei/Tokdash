...
def test_frontend_session_registry_includes_cline():
    ...
    assert "antigravity_cli: null, cline: null, workbuddy: null, qoder: null, qwen_code: null, openclaw: null, qoder_cli: null, goose: null, roo_code: null, combined: null" in source
